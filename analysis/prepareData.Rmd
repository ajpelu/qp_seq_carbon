...
### QP_DASOMETRICO
* Parcelas realizadas en varias de las poblaciones de robledal especificamente para caracterizar la estructura
...
# Data 
qp_dasometricoData <- read_csv(here::here("raw_data/camarate/qp_dasometrico_tree_data.csv"), col_types = cols()) %>% 
  filter(dis < 16) %>% 
   mutate(sp = case_when(
    sp == "Quercus pyrenaica" ~ "Qpyr",

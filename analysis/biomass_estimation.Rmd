...
plot_s <- dicc_plots %>% 
  inner_join(df, by = c("original_code" = "code")) %>% 
...
```{r}
df_tree_sel <- df_tree %>% 
  filter(code %in% plot_s$original_code)
...
# Modelos ecuaciones 
Pistacia terebinthus: from Blanco Oyonarte et al. 2003
Crataegus monogyna: from Blanco Oyonarte et al. 2003
